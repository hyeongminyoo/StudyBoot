	...
	SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
				...
				.rememberMe() //RememberMe 설정
					...
					.authenticationSuccessHandler(loginSuccess)//로그인 성공시 핸들러
					.and()
				.oauth2Login()
					.userInfoEndpoint()
...
//	@Bean
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://127.0.0.1:5500","http://192.168.1.28:5500","*")); //List<Integer>
